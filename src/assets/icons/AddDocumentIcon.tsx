export const AddDocument = (props: React.SVGAttributes<HTMLOrSVGElement>) => {
  return (
    <svg className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" {...props}>
